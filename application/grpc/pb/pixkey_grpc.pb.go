...
const (
	PixService_RegisterPixKey_FullMethodName = "/github.com.wr2net.codepix.PixService/RegisterPixKey"
	PixService_Fin_FullMethodName            = "/github.com.wr2net.codepix.PixService/Fin"
)
...
func (c *pixServiceClient) Fin(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error) {
	out := new(PixKeyInfo)
	err := c.cc.Invoke(ctx, PixService_Fin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PixService_Fin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PixService_Fin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.wr2net.codepix.PixService",
